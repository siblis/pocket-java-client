...
public class AlarmDeleteGroup extends AnchorPane {
    ...
    public AlarmDeleteGroup() {


        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/client/fxml/AlarmWindowDeleteGroup.fxml"));
