...
public class AlarmExitProfile extends AnchorPane {
    ...
    public AlarmExitProfile() {


        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/client/fxml/AlarmWindowQuitProfile.fxml"));
