...
public class AlarmGroupQuitGroup extends AnchorPane {
    ...
    public AlarmGroupQuitGroup() {


        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/client/fxml/AlarmWindowQuitGroup.fxml"));
